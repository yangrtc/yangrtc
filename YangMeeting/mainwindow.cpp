...
void MainWindow::initIni(YangMeetingContext *pini){
    m_ini=pini;
...
void MainWindow::showMessage(QString str){
    m_tip->m_text+=str;
    //emit YangShowMessage();
    // qDebug()<<"MainWindow shwo message...."<<str;
    m_videoThread->setShowMessage(str);
...
void MainWindow::on_MainWindow_customContextMenuRequested(const QPoint &pos)
{
  //  qDebug()<<"--------------------------start context"<<m_videoMeeting->m_state;
    ...
    int strlen=m_ini->sys.isMultCamera?11:10;
