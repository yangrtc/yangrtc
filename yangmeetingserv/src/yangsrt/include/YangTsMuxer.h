...
public:
    ...
    void create_pes(YangTsPes *frame,uint8_t *p,int plen,int frametype,long long timestamp,YangTsStream streamType);
    void create_pcr(YangTsBuffer *sb);
    void create_null(YangTsBuffer *sb);
    void encode(uint8_t* p,int plen,int frametype,long long timestamp ,YangTsStream streamType,vector<YangTsBuffer> *sb);
    void encodeWithPmt(uint8_t* p,int plen,int frametype,long long timestamp ,YangTsStream streamType,vector<YangTsBuffer> *sb);
