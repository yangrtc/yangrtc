...
YangHttpUtil::YangHttpUtil(YangMeetingContext *pini)
{
    ...
    // m_hb=NULL;
    m_ip=QString(pini->avinfo.sys.httpServerIP);
    m_port=pini->avinfo.sys.httpPort;
   // qDebug()<<"app====="<<pini->hd.app;
    m_url=QString::asprintf("http://%s:%d/%s",pini->avinfo.sys.httpServerIP,m_port,pini->hd.app);
