...
INCLUDEPATH += $$HOME_BASE/libmetameeting5/src/include
LIBS += -lmetartcmeeting5 -lmetartc5 -lmetartccore5 -lyuv -lopus -lopenh264 -lspeexdsp -lavutil -lavcodec -lusrsctp
#-lyangrtcext2
unix{
