...
int main(int argc, char *argv[])
{
    ...
    YangSysMessageHandle *sysmessage=mf.createSysMessageHandle(w.m_context,&w);
    ...
    videoThread.initPara(w.m_context);
    w.initVideoThread();
    //videoThread.m_tip=w.m_tip;
    videoThread.m_previewBuffer=w.m_videoMeeting->getPreviewVideo();
    videoThread.start();
