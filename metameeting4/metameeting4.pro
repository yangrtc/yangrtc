...
INCLUDEPATH += $$HOME_BASE/libmetameeting4/src/include
LIBS += -lmetartcmeeting4 -lmetartc4 -lmetartccore4 -lyuv -lopus -lopenh264 -lspeexdsp -lavutil -lavcodec -lusrsctp
#-lyangrtcext2
unix{
