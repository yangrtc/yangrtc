...
class YangReceive:public YangReceiveCallback,public YangMediaConfigCallback {
public:
...
protected:
    ...
    YangPeerConnection2* getPlayer(int32_t puid);
	int32_t getPlayIndex(int32_t puid);
    vector<YangPeerConnection2*> m_players;
protected:
